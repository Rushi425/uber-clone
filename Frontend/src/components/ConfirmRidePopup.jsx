        ...
        <div className='flex gap-2 justify-between flex-col items-center'>
            <div className='w-full'>
                ...
                <div className='flex items-center gap-5 p-3'>
                    ...
                    <div>
                        <h3 className='text-lg font-medium'>{props.ride?.firstname}</h3>
            ...
            <div className='w-full mt-6'>
               <form onSubmit={()=>{
                    ...
                    <button  className='w-full text-lg text-center flex justify-center bg-green-600 text-white-500 font-semibold p-2 rounded-lg'>Confirm</button>
                    <button onClick={()=>{
                        props.setConfirmRidePopupPanel(false)       
