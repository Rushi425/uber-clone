    ...
    <div>
        ...
        <div className='flex gap-2 justify-between flex-col items-center'>
            ...
            <div className='w-full mt-6'>
               <Link to='/captain-home' className='w-full text-center flex justify-center bg-green-600 text-white-500 font-semibold p-2 rounded-lg'>Finish</Link>             
                <p className='text-red-500 text-xs mt-6'>Click on finish button if you are completed the payment.</p>
            </div>
        </div>
    </div>
  )
