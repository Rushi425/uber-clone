  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
      ...
      <div>
        ...
        <p className='text-center'>Join a fleet? <Link to='/captain-signup' className='text-[#10b461]'>Register as a Captain</Link></p>
        </form>
      </div>

      <div>
        <Link to='/login' className='bg-[#b99c32] flex items-center justify-center text-white font-semibold mb-7 rounded px-4 py-2 0 w-full text-lg placeholder:text-base'>Sign In as User</Link>
      </div>
    </div>
  );
}
